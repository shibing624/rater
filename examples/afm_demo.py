...
def train(x_idx, x_value, label, features, out_type='binary'):
    ...
    model = AFM(feature_size=features.feature_size(), field_size=features.field_size(),embedding_size=5,
...
if __name__ == '__main__':
    ...
    features, X_idx, X_value, y, category_index, continuous_value = dataset.get_features(use_category_columns=True,
                                                                                         use_continuous_columns=True)
